...
----------------------------------------------------------------------------------------------------------------------------------------------
local Fluent = loadstring(game:HttpGet("https://raw.githubusercontent.com/Nchanquadi/Whaing/main/Winhar_main.txt"))()
...
local Window = Fluent:CreateWindow({
    Title = "Matsura hub [Winter Hub update Matsura hub]",
...
local Tabs = {
    profile = Window:AddTab({ Title = "Information", Icon = "swords" }),
    Main = Window:AddTab({ Title = "Farm item", Icon = "swords" }),
    Sea = Window:AddTab({ Title = "Sea Event", Icon = "swords" }),
    Setting = Window:AddTab({ Title = "Settings", Icon = "swords" }),
    Status = Window:AddTab({ Title = "Server Stats", Icon = "swords" }),
    Stats = Window:AddTab({ Title = "Stats", Icon = "swords" }),
    Player = Window:AddTab({ Title = "Player", Icon = "swords" }),
    Teleport = Window:AddTab({ Title = "Teleport", Icon = "swords" }),
    Fruit = Window:AddTab({ Title = "Fruit Blox ESP", Icon = "swords" }),
    Raid = Window:AddTab({ Title = "Dungeon", Icon = "swords" }),
    Race = Window:AddTab({ Title = "Race Trial V4", Icon = "swords" }),
    Shop = Window:AddTab({ Title = "Shopee", Icon = "swords" }),
	Misc = Window:AddTab({ Title = "Miscellaneous", Icon = "swords" }),
    Hop = Window:AddTab({ Title = "Hop Server", Icon = "swords" }),
}
...
ImageButton.Image = "rbxassetid://17314862794"

UICorner.CornerRadius = UDim.new(0, 15)
UICorner.Parent = ImageButton

UIGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(197, 84, 235)), ColorSequenceKeypoint.new(0.20, Color3.fromRGB(211, 56, 232)), ColorSequenceKeypoint.new(0.40, Color3.fromRGB(237, 237, 237)), ColorSequenceKeypoint.new(0.60, Color3.fromRGB(237, 237, 237)), ColorSequenceKeypoint.new(0.80, Color3.fromRGB(217, 79, 227)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(247, 25, 143))}
...
--------------------------------------------------------------------------------------------------------------------------------------------
    ...
    local ToggleCastleRaid = Tabs.Main:AddToggle("ToggleCastleRaid", {
        Title = "kill Pirates Castle Raid",
        Description = "", 
        Default = false })
...
Tabs.Main:AddButton({
    ...
    Callback = function()
        ...
        loadstring(game:HttpGet("https://raw.githubusercontent.com/Yatsuraa/Yuri/main/WinterAutochestFarm.lua"))()
    end
})

Tabs.Main:AddButton({
    Title = "Auto Find Fruit Spam",
    Description = "lụm fruit spam đổi server",
    Callback = function()
        _G.JoinTeam = "Pirates"
        _G.Stop_If_Has_Items = true
        loadstring(game:HttpGet("https://raw.githubusercontent.com/Yatsuraa/Yuri/main/WinterAutofruit.lua"))()
    end
})
...
local Toggle = Tabs.Setting:AddToggle("MyToggle", {Title = "Anti Flag", Default = true })
...
spawn(function()
    ...
    local Toggle = Tabs.Setting:AddToggle("MyToggle", {Title = "Auto click", Default = false })
...
local Toggle = Tabs.Race:AddToggle("MyToggle", {Title = "Auto Kill Player", Default = false })
...
Tabs.profile:AddParagraph({
        ...
        Content = "https://discord.com/invite/JpmaUUBYks"
    })      
--------------------------------------------------------------------------------------------------------------------------------------------
--Hop
